...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Dashboard | Airport App</title>
        ...
        <link href="{{asset('backend/assets/libs/datatables.net-autoFill-bs4/css/autoFill.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('backend/assets/libs/datatables.net-keytable-bs4/css/keyTable.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />
